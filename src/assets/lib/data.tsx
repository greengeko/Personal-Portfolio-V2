...
export const headerIntroData = {
  ...
  subtitle: "Web Developer II UI/UX Designer II Freelancer II Tech Enthusiast",
  description: {
    ...
    en: "Hello, I'm Alvin Dennis, a Tech Enthusiast and a Web Developer with a passion for creating innovative web applications. I have a deep understanding of the full web development life cycle. I am proficient in C, Python, Html, CSS and a bunch of frameworks, such as Django and React. I have experience working with databases such as MySQL. Currently I am exploring as well as have practical experience in IoT, DevOps, Figma and software quality testing. I look forward to learning new tools and technologies and gaining new experiences.",
  },
  buttons: [
    {
      name: "Contact",
...
export const projectsData = [
  {
    ...
    githuburl: "https://github.com/alvin-dennis",
    githubicon: FiGithub,
...
export const sideBarRightMail = {
  link: "mailto:alvindennis80@gmail.com",
  text: "alvindennis80@gmail.com",
} as const;

export const sideBarLeftSocials = [
  {
    link: "https://www.linkedin.com/in/alvin-dennis-0a70ba163/",
    icon: FiLinkedin,
    altimgname: "linkedin",
  },
  {
    link: "https://github.com/alvin-dennis",
    icon: FiGithub,
    altimgname: "github",
  },
  {
  ...
  paragraphs_EN: [
    {
      ...
      description:
        "Sharjah Indian School  2014-2019",
      icon: hardwareicon,
    },
    {
      title: "Higher Secondary Education",
      description:
        "Sharjah Indian School  2019-2021",
      icon: caricon,
    },
    {
      title: "B.Tech in Electrical and Electronics Engineering",
      description:
        "St. Joseph's College of Engineering and Technology  2021-2025",
      icon: travelicon,
    },
  ],
};
...
export const contactData = {
  ...
  privacyOptIn: {
    checkbox: {
      ...
      en: "I agree that Alvin may use my personal data (name and e-mail address) to contact me.",
    },
    description: {
