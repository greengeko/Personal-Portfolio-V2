...
const ServiceStatus: React.FC = () => {
  ...
  return (
    <React.Fragment>
      <Link to="https://statussite.betteruptime.com">
        <div className="status p-4 rounded-xl flex flex-row items-center">
          ...
          <p className={`status-text ${statusColor()} `}>Status:{status}</p> <iframe src="https://statussite.betteruptime.com/badge" width="176" height="30" frameBorder="0" scrolling="no" ></iframe>
        </div>
      </Link>
    </React.Fragment>
  );
